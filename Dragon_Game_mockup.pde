...
void generate() {
  ...
  lattice = new Quasicrystal(w, x, y, z, r);
  ...
  chunk_lattice = new Quasicrystal(w.times(1.0/chunk_ratio), x.times(1.0/chunk_ratio), y.times(1.0/chunk_ratio), z.times(1.0/chunk_ratio), r*(1.0/chunk_ratio));
